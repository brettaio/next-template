    ...
    return (
        <footer className="mt-auto bg-white">
            <div className="container">
                <div className=" grid grid-cols-1 gap-x-4 gap-y-4 py-14 lg:grid-cols-5 lg:py-[50px]">
                    <div className="relative mx-auto">
                        <Image src={mugShot} alt="bretta etc logo in the bottom footer" className="w-auto" />
                    </div>

                    <div>
                        <ul className="flex flex-col gap-3 text-center font-bold">
                            <li className="mb-3 text-lg font-extrabold text-black">Bretta Etc</li>
                            <li>
